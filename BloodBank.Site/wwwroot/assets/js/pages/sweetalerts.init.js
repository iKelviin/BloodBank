document.addEventListener('DOMContentLoaded', function () {
    console.log("SweetAlert Carregado!");
    carregarSweetAlert();
});
...
function ConfirmChange(changeData) {
    return Swal.fire({
        title: "Tem certeza?",
        text: "Seu livro será alterado para " + changeData + "!",
        icon: "warning",
        showCancelButton: true,
        customClass: {
            confirmButton: "btn btn-primary w-xs me-2 mt-2",
...
function AvailableSuccess(){
    Swal.fire({
        position: "top-end",
        icon: "success",
        title: "Disponibilizado com sucesso.",
        showConfirmButton: !1,
        timer: 1500,
        showCloseButton: !0
    })
